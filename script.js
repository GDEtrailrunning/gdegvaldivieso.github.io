...
const dataLine1 = {
  ...
  datasets: [{
    ...
    data: [16, 17, 10, 20, 33], // Datos de los km recorridos en cada día
...
const dataLine2 = {
  ...
  datasets: [{
    ...
    data: [15, 13, 13, 22, 25], // Datos de los km recorridos en cada día
...
function actualizarDiasRestantes() {
  // Fecha objetivo fija
  const objetivoDate = new Date('2026-09-28');
